...
mixin _$UserProfileModel {
  ...
  List<PostModel>? get likedItems => throw _privateConstructorUsedError;
  List<PostModel>? get myPosts => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      likes: likes == freezed
          ...
          : likes // ignore: cast_nullable_to_non_nullable
              as int?,
      likedItems: likedItems == freezed
          ? _value.likedItems
          : likedItems // ignore: cast_nullable_to_non_nullable
              as List<PostModel>?,
      myPosts: myPosts == freezed
          ? _value.myPosts
...
class _$_UserProfileModel implements _UserProfileModel {
  const _$_UserProfileModel(
      ...
      this.followers = 0,
      this.likes = 0,
      final List<PostModel>? likedItems = const [],
      final List<PostModel>? myPosts = const []})
  ...
  @JsonKey()
  final int? likes;
  final List<PostModel>? _likedItems;
  @override
  @JsonKey()
  List<PostModel>? get likedItems {
...
abstract class _UserProfileModel implements UserProfileModel {
  const factory _UserProfileModel(
      ...
      final int? followers,
      final int? likes,
      final List<PostModel>? likedItems,
      final List<PostModel>? myPosts}) = _$_UserProfileModel;
